...
JobBoardScraper/
  ...
  Scrapers/                  # Скраперы Habr Career (11 скраперов)
  Infrastructure/
...
Интегрирован с системой прокси — получает прокси через `ProxyCoordinator` и распознаёт сообщение о суточном лимите Habr Career для автоматической смены IP. Интервал обхода: 20 минут.
