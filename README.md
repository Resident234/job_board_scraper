...
- **Высшее образование:**
  - Университеты (ID, название, город, количество выпускников)
  - Курсы/факультеты с периодами обучения
  - Описание образования
  - Хранение курсов в JSONB формате
...
- Интеграция с таблицами habr_skills, habr_user_skills, habr_user_experience, habr_user_experience_skills, habr_universities, habr_resumes_universities
