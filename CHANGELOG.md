...
- Зафиксирована интеграция `ProxyRotator` в `UserResumeDetailScraper`:
  ...
  - ротация предназначена для обхода IP-лимита Habr Career на просмотр профилей специалистов и распределения запросов по разным прокси;
...
- Новая функциональность извлечения дополнительных данных из профилей пользователей Habr Career
- Извлекаемые поля:
