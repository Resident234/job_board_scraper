...
Функциональность парсинга блока "Высшее образование" из профилей резюме на career.habr.com. Извлекает информацию об университетах, курсах и периодах обучения.

## Извлекаемые данные

### Университет
- **Название** — название ВУЗа (например, "ВАГС")
- **Habr ID** — уникальный идентификатор на career.habr.com (например, 6081)
