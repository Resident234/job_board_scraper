...
- **Высшее образование (education)** — университеты, курсы и периоды обучения
...
- ✅ Извлечение опыта работы с компаниями и навыками
- ✅ Извлечение высшего образования (университеты, курсы, периоды)
...
- Секция: `.content-section` с заголовком "Высшее образование"
- Элементы: `.resume-education-item`
- Извлекаемые данные:
  - Университет (ID, название, город, количество выпускников)
  - Курсы (название, период, продолжительность, текущее обучение)
  - Описание образования
- Таблицы: `habr_universities`, `habr_resumes_universities`
- Подробнее: [UNIVERSITY_EDUCATION_SCRAPER.md](UNIVERSITY_EDUCATION_SCRAPER.md)
