...
public sealed class UserResumeDetailScraper : IDisposable
{
    ...
    /// <summary>
    /// Get proxy from coordinator with timeout
    /// </summary>
    ...
    private async Task ScrapeAllUserResumesAsync(CancellationToken ct)
    {
            ...
            body: async userLink =>
        {
            ...
            try
            {
                ...
                var (age, experienceText, registration, lastVisit, citizenship, remoteWork) = ProfileDataExtractor.ExtractAdditionalProfileData(doc);
